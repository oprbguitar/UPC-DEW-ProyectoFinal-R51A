...
class LocalsControllerTest < ActionController::TestCase
  ...
  test "should create local" do
    assert_difference('Local.count') do
      post :create, local: { di_google_maps: @local.di_google_maps, direccion: @local.direccion, distrito: @local.distrito, nombre: @local.nombre, telefono: @local.telefono }
    end
  ...
  test "should update local" do
    put :update, id: @local, local: { di_google_maps: @local.di_google_maps, direccion: @local.direccion, distrito: @local.distrito, nombre: @local.nombre, telefono: @local.telefono }
    assert_redirected_to local_path(assigns(:local))
  end
